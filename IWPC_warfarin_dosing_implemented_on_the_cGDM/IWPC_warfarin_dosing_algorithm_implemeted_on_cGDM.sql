...
FROM GENOMIC_ALTERATION GA WHERE HGNC_Gene_Symbol = 'VKORC1' AND dbSNP_ID in ('rs9923231') AND Reference_Allele = 'G' AND Alternative_Allele = 'A'
UNION
...
FROM GENOMIC_ALTERATION GA WHERE HGNC_Gene_Symbol = 'CYP2C9' AND dbSNP_ID in ('rs9332094') AND Reference_Allele = 'T' AND Alternative_Allele = '-'
UNION
...
FROM GENOMIC_ALTERATION GA WHERE HGNC_Gene_Symbol = 'CYP2C9' AND dbSNP_ID in ('rs1799853') AND Reference_Allele = 'C' AND Alternative_Allele = 'T' 
UNION
...
FROM GENOMIC_ALTERATION GA WHERE HGNC_Gene_Symbol = 'CYP2C9' AND dbSNP_ID in ('rs1057910') AND Reference_Allele = 'A' AND Alternative_Allele = 'C'; 
